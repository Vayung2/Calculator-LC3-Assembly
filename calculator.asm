...
;In this program, we built subroutines to handle individual computations. 
; We then checked if the input character was a number,	and pushed it to the stack if it was
; we then checked if an operand was input, and popped twice from the stack if it was
; we called the subroutine based on the operand, and pushed its computed answer onto the stack
; at the end, there remains a single value on the stack, which is printed to the screen
